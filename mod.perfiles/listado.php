...
from perfiles a
where lower(a.nomPerfil) like lower('%$txtNombre%')
and a.isActivo in ($cmbEstadoFilter)
order by a.nomPerfil
") ;
...
<div class="column100">
    ...
    <div class="widget">
    	<div class="widget_header">
            <i class="icon-widget fa-list"></i><h3>Listado de Perfiles</h3>
        </div>
        <div class="widget_content">
        	...
        	<div id="PanelDetalle">
             <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="TDTitle">Busqueda<a id="btnNuevo" href="mant_Perfil.php" class="btn right"><i class="icon-fa fa-file-o"></i>Agregar Perfil</a></td>
                </tr>
                <tr>
                  ...
                  <td><table cellpadding="0" cellspacing="1" class="adminList">
                    ...
                    <?php
						while ($sRow = fn_ExtraerQuery($sQL))
						{
							...
							$imgAccesos = "<a href='ls_perfilAccesos.php?id=$idPerfil' title='Detalle de Accesos'>";
							$imgAccesos .= "<img src='".JPATH_BASE_WEB.DSW."imagenes/_ui_menu_16.png' title='Inactivo' /></a>";

							$hrefEdit 	= "mant_Perfil.php?id=".$idPerfil;
							
						?>
                    <tr>
                      <td><a href="<?php echo $hrefEdit; ?>" title="Editar Perfil"><?php echo $nomPerfil ?></a></td>
                      <td class="alinearCentro"><?php echo $imgActivo ?></td>
                      <td class="alinearCentro"><?php echo $imgAccesos ?></td>
                    </tr>
                    <?php
						}
						?>
